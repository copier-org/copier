...
class Worker:
    ...
    def _apply_update(self) -> None:  # noqa: C901
        ...
        subproject_skip_paths = set(filter(self.match_skip, subproject_paths))
        ...
        with (
            ...
            # Create a fresh copy based on the old template into a temporary destination.
            with replace(
                self,
