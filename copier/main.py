...
class Worker:
    ...
    def answers_relpath(self) -> Path:
        ...
        # FIXME: A loop has been introduced in 25bc06d01:
        # this property is rendered using self.answers.combined so self.answers.system
        # which is generated by self._system_render_context()
        # which uses this property to build the _copier_conf dict
        return Path(self._render_string(str(path), {"_copier_phase": self.phase.value}))
    ...
    def _render_string(
        ...
        ctx = {**self.answers.combined, **(extra_context or {})}
