...
| `overwrite`        | `bool`                     | When `True`, overwrite files that already exist, without asking.<br>See [overwrite][].                                                                                                                                                                                                                                 |
| `pretend`          | `bool`                     | When `True`, produce no real rendering.<br>See [pretend][].                                                                                                                                                                                                                                                            |
| `quiet`            | `bool`                     | When `True`, disable all output.<br>See [quiet][].                                                                                                                                                                                                                                                                     |
...
| `use_prereleases`  | `bool`                     | Consider prereleases when detecting the _latest_ one?<br>See [use_prereleases][].<br>Has no effect if specifying [vcs_ref][].                                                                                                                                                                                          |
| `user_defaults`    | `AnyByStrDict`             | Specify user defaults that may override a template's defaults during question prompts.                                                                                                                                                                                                                                 |
| `unsafe`           | `bool`                     | When `True`, allow usage of unsafe templates.<br>See [unsafe][].                                                                                                                                                                                                                                                       |
