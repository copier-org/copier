...
| `settings`         | <code>[Settings][copier.settings.Settings]</code> | Specified settings that control copier's behavior.<br>See the [`settings`][] page for related information.                                                                                                                                                 |
